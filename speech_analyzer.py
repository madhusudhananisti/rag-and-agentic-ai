...
Based on the meeting transcript below, generate useful meeting minutes.
Include:

A concise summary of the meeting.
Key points discussed.
Decisions that were made.
A task list with actionable items, assignees, and deadlines if they are mentioned.
Any relevant notes or context.

Do not describe what you are doing.
Do not repeat the instructions.
Do not return an empty template.
...
download_file = gr.File(
    label="Download the Generated Meeting Minutes and Tasks"
)
iface = gr.Interface(
    fn=transcript_audio,
    inputs=audio_input,
